              ...
              <div className="lg:col-span-7 space-y-10 animate-in fade-in slide-in-from-bottom-10 duration-1000">
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-xl text-slate-500 leading-relaxed max-w-2xl font-medium tracking-tight">
                    {settings?.institutionSynopsis || "Daftar sekarang dan bergabunglah dengan komunitas pembelajar paling inovatif untuk merancang masa depan karir digital Anda."}
                  </p>
                </div>
                ...
                <div className="space-y-10">
                  <div className="space-y-3">
                    ...
                    <p className="text-slate-500 leading-relaxed font-medium">
                      {settings?.institutionHistory || "Institusi kami berdiri dengan dedikasi tinggi untuk pendidikan berkualitas..."}
                    </p>
                  </div>
                  <div className="p-10 bg-white rounded-[3rem] border border-slate-100 shadow-xl shadow-black/5 relative overflow-hidden group">
                    ...
                    <p className="text-slate-500 leading-relaxed font-semibold italic text-lg relative z-10">
                      "{settings?.institutionVision || "Visi institusi kami adalah mencetak pemimpin masa depan di era digital."}"
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              <div className="lg:col-span-3 p-12 md:p-16 bg-slate-900 rounded-[4rem] text-white flex flex-col justify-between items-start gap-12 relative overflow-hidden group shadow-2xl">
                ...
                <div className="relative z-10 group/btn flex items-center gap-6 flex-wrap">
                  <a href={`https://wa.me/${settings?.contactWhatsapp || "6285775870428"}`} target="_blank" className="px-10 py-5 bg-green-600 hover:bg-white hover:text-green-700 rounded-full font-black transition-all shadow-xl shadow-green-900/20 flex items-center gap-3">
                ...
                <div className="p-12 bg-red-100 rounded-[4rem] text-red-900 space-y-6 flex flex-col justify-between flex-1 hover:bg-red-200 transition-all duration-300">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    {settings?.costDetails && (
                      <a href={`/assets/img/${settings.costDetails}`} target="_blank" className="px-8 py-4 bg-red-700 hover:bg-slate-900 text-white rounded-3xl font-black transition-all flex items-center justify-between shadow-xl shadow-red-500/10">
                        Rincian Biaya
        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-20">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-12 w-full lg:w-auto text-center sm:text-left">
               {[
                 ...
                 { t: 'Kontak', l: [`WA: ${settings?.contactWhatsapp || "-"}`, `Email: info@pamitran.ac.id`] }
               ].map(group => (
          ...
          <div className="mt-20 pt-10 border-t border-slate-50 flex flex-col md:flex-row justify-between items-center gap-6">
             <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">
                © {new Date().getFullYear()} {settings?.institutionName || "STMIK Pamitran"}. All rights reserved.
             </p>
